...
// import { getPostsById, getPostsBulk } from './api';

const getPostsById = (id) => fetch(`https://jsonplaceholder.typicode.com/Posts/${id}`);
const getPostsBulk = () => fetch('https://jsonplaceholder.typicode.com/posts');
